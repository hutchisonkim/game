...
internal static class ChessBoardStamps
{
    ...
    // ─────────────────────────────────────────────────────────────
    internal static Bitmap StampBoard(ChessBoard_Old state, int boardSize, bool includePieces = true)
    {
        if (state is null)
    ...
    // PIECES
    // ─────────────────────────────────────────────────────────────
    internal static void StampPieces(Graphics g, Piece?[,] board, int cell)
    {
        for (int r = 0; r < 8; r++)
            for (int f = 0; f < 8; f++)
            {
    ...
    internal static Bitmap StampPiecesLayer(Piece?[,] board, int cell)
    {
        var bmp = new Bitmap(cell * 8, cell * 8);
        using var g = Graphics.FromImage(bmp);
    ...
    internal static void StampPiece(Graphics g, Rectangle rect, Piece piece, int cell)
    {
